...
const Footer = () => {
  return (
    <div className='flex items-center justify-between w-full text-dark px-28 py-8 border-t-dark border-4 md:p-4 md:!relative text-sm sm:flex-col sm:items-center sm:space-y-4'>
